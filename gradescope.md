...
1. Open the project directory in a file explorer. This can be done by
   right-clicking any file in the **Explorer** tab on VSCode and
   selecting "Reveal in File Explorer".

   ![Reveal in File Explorer](/assets/images/reveal-in-explorer.png)
2. Select all files **inside** the project directory and create a ZIP
   ...
   ![Create ZIP Archive](/assets/images/create-zip-archive.png)
